module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'tomopt_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'tomopt_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'tomopt_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
      ...
      vendor: {
        files: [
...

          {
            ...
            dest: 'tomopt_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'tomopt_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "tomopt_sphinx_theme/static/css/theme.css": "tomopt_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'tomopt_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['tomopt_sphinx_theme/static/js/*.js', '!tomopt_sphinx_theme/static/js/*.min.js'],
          dest: 'tomopt_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["tomopt_sphinx_theme/static/fonts"],
      images: ["tomopt_sphinx_theme/static/images"],
      css: ["tomopt_sphinx_theme/static/css"],
      js: ["tomopt_sphinx_theme/static/js/*", "!tomopt_sphinx_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['tomopt_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
